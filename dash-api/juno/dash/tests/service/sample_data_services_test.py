...
"""
    ...
    def test_get_csv_download_reject_invalid_params(self):
        ...
        with self.assertRaises(RuntimeError):
            metadata_download = self.monocle_data.get_csv_download(
                "any_name.csv", download_links={"hostname": "any.server", "institution": "any institution"}
            )
        ...
        with self.assertRaises(RuntimeError):
            metadata_download = self.monocle_data.get_csv_download(
                "any_name.csv",
                sample_status={
                    "institution": self.mock_institutions[0],
                    "category": "sequencing",
                    "status": "successful",
                },
                sample_filters={"metadata": {"any field": "any value"}},
                download_links={"hostname": "any.server", "institution": "any institution"},
            )
    ...
    def test_metadata_as_csv(self, mock_metadata_fetch, mock_in_silico_data_fetch, mock_qc_data_fetch):
        ...
        metadata_as_csv = self.monocle_data.metadata_as_csv(
            sample_status={"institution": self.mock_institutions[0], "category": "sequencing", "status": "successful"},
    ...
    @patch.object(Monocle_Download_Client, "in_silico_data")
    @patch.object(Monocle_Download_Client, "metadata")
    def test_metadata_as_csv_qc_data_requested(
        self, mock_metadata_fetch, mock_in_silico_data_fetch, mock_qc_data_fetch
    ):
        mock_metadata_fetch.return_value = self.mock_metadata
        mock_in_silico_data_fetch.return_value = self.mock_in_silico_data
    ...
    @patch.object(Monocle_Download_Client, "in_silico_data")
    @patch.object(Monocle_Download_Client, "metadata")
    def test_metadata_as_csv_when_no_in_silico_or_qc_data_available(
        self, mock_metadata_fetch, mock_in_silico_data_fetch, mock_qc_data_fetch
    ):
        mock_metadata_fetch.return_value = self.mock_metadata
    ...
    @patch.object(Monocle_Download_Client, "in_silico_data")
    @patch.object(Monocle_Download_Client, "metadata")
    def test_metadata_as_csv_when_no_in_silico_or_qc_data_available_qc_data_requested(
        self, mock_metadata_fetch, mock_in_silico_data_fetch, mock_qc_data_fetch
    ):
        mock_metadata_fetch.return_value = self.mock_metadata
        mock_in_silico_data_fetch.return_value = self.in_silico_data_available_not_available
    ...
    @patch.object(Monocle_Download_Client, "in_silico_data")
    @patch.object(Monocle_Download_Client, "metadata")
    def test_metadata_as_csv_when_in_silico_data_has_bad_lane_id(
        self, mock_metadata_fetch, mock_in_silico_data_fetch, mock_qc_data_fetch
    ):
        mock_metadata_fetch.return_value = self.mock_metadata
    ...
    @patch.object(Monocle_Download_Client, "in_silico_data")
    @patch.object(Monocle_Download_Client, "metadata")
    def test_metadata_as_csv_invalid_metadata_merge_fails(
        self, mock_metadata_fetch, mock_in_silico_data_fetch, mock_qc_data_fetch
    ):
    ...
    @patch.object(Monocle_Download_Client, "in_silico_data")
    @patch.object(Monocle_Download_Client, "metadata")
    def test_metadata_as_csv_invalid_in_silico_merge_fails(
        self, mock_metadata_fetch, mock_in_silico_data_fetch, mock_qc_data_fetch
    ):
        mock_metadata_fetch.return_value = self.mock_metadata
    ...
    @patch.object(Monocle_Download_Client, "in_silico_data")
    @patch.object(Monocle_Download_Client, "metadata")
    def test_metadata_as_csv_invalid_qc_data_merge_fails(
        self, mock_metadata_fetch, mock_in_silico_data_fetch, mock_qc_data_fetch
    ):
        mock_metadata_fetch.return_value = self.mock_metadata
        mock_in_silico_data_fetch.return_value = self.mock_in_silico_data
    ...
    def test_metadata_as_csv_reject_invalid_params(self):
        ...
        with self.assertRaises(RuntimeError):
            metadata_as_csv = self.monocle_data.metadata_as_csv(
                sample_status={"anything": "will do"},
