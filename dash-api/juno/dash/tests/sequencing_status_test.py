...
from   dash.api.service.DataSources.sequencing_status  import MLWH_Client
from   dash.api.service.DataSources.sequencing_status  import ProtocolError
...
class SequencingStatusTest(TestCase):
   ...
   def test_get_sample(self, mock_request):
      ...
      for required in self.required_sample_keys.keys():
         ...
         self.assertIsInstance(sample[required], self.required_sample_keys[required], msg="sample item {} is wrong type".format(required))
