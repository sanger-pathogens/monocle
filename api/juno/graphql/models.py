...
class AffiliationModel(db.Model):
    ...
    user = db.relationship("UserModel", backref=db.backref("affiliation", cascade="all, delete-orphan"))
    institution = db.relationship("InstitutionModel", backref=db.backref("affiliation", cascade="all, delete-orphan"))
...
class UserModel(db.Model):
    ...
    affiliated_institutions = db.relationship("InstitutionModel", secondary="affiliation")
