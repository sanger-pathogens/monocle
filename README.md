...
See [Monocle development documentation](https://gitlab.internal.sanger.ac.uk/sanger-pathogens/monocle-developer) in a separate repo for more.
...
LDAP service as an LDIF file. Log in as `admin` at `/ldap-admin' (the password is in your `openldap-env.yaml` file) and use the "Export" function; be certain to
...
- Several release _modes_ are allowed:
