...
DDROP TABLE IF EXISTS `gps_in_silico`;
...
REATE TABLE `gps_sample` (
  ...
  `latitude` DECIMAL(14,10) CHECK (latitude>=-180 AND latitude<=180),
  `longitude` DECIMAL(14,10) CHECK (longitude>=-180 AND longitude<=180),
