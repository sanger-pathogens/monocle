...
CREATE TABLE `gps_sample` (
  ...
  `year_collection` VARCHAR(10),
  `gender` VARCHAR(10) DEFAULT NULL,
  `age_years` VARCHAR(30),
  `age_months` VARCHAR(10),
  `age_days` VARCHAR(10),
...
CALL update_database_version('0.4.0', 'Regenerate all gps tables using v 3.4 GPS schema');
