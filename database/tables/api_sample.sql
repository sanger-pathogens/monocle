...
CREATE TABLE `api_sample` (
  ...
  `submitting_institution` SMALLINT(6) NOT NULL,
  ...
  `age_years` SMALLINT(6) DEFAULT NULL,
  `age_months` SMALLINT(6) DEFAULT NULL,
  `age_weeks` SMALLINT(6) DEFAULT NULL,
  `age_days` SMALLINT(6) DEFAULT NULL,
  ...
  `birth_weight_gram` SMALLINT(6) DEFAULT NULL,
