...
class Metadata:
    ...
    latitude: float  # optional; must be a number between -180 and 180, with up to 9 decimal places
    longitude: float  # optional; must be a number between -180 and 180, with up to 9 decimal places
