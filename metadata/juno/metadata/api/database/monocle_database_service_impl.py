        ...
        with self.connector.get_transactional_connection() as con:
            for in_silico_data in in_silico_data_list:
                con.execute(
                    ...
                    adhP=self.convert_int(in_silico_data.adhP),
                    pheS=self.convert_int(in_silico_data.pheS),
                    atr=self.convert_int(in_silico_data.atr),
                    glnA=self.convert_int(in_silico_data.glnA),
                    sdhA=self.convert_int(in_silico_data.sdhA),
                    glcK=self.convert_int(in_silico_data.glcK),
                    tkt=self.convert_int(in_silico_data.tkt),
