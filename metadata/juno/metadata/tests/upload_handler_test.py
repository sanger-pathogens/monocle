...
class TestInSilicoUploadHandler(unittest.TestCase):
    ...
    def __check_validation_errors(self, validation_errors: List[str]):
        ...
        self.assertTrue(
            '{row: 2, column: "23S1"}: "[pos]" must be pos and neg' in validation_errors)
        self.assertTrue(
            '{row: 3, column: "23S3"}: "*" must be pos and neg' in validation_errors)
        self.assertTrue(
            '{row: 3, column: "ERMB"}: "_" must be pos and neg' in validation_errors)
        self.assertTrue(
            '{row: 2, column: "ERMT"}: "0" must be pos and neg' in validation_errors)
        self.assertTrue(
            '{row: 3, column: "FOSA"}: "\'\'" must be pos and neg' in validation_errors)
        self.assertTrue(
            '{row: 2, column: "GYRA"}: "+" must be pos and neg' in validation_errors)
        self.assertTrue(
            '{row: 3, column: "LNUB"}: "\'\'" must be pos and neg' in validation_errors)
        self.assertTrue(
            '{row: 2, column: "LSAC"}: "\'\'" must be pos and neg' in validation_errors)
        self.assertTrue(
            '{row: 3, column: "MEFA"}: "\'\'" must be pos and neg' in validation_errors)
        self.assertTrue(
            '{row: 2, column: "MPHC"}: "\'\'" must be pos and neg' in validation_errors)
        self.assertTrue(
            '{row: 3, column: "MSRA"}: "\'\'" must be pos and neg' in validation_errors)
        self.assertTrue(
            '{row: 2, column: "MSRD"}: "\'\'" must be pos and neg' in validation_errors)
        self.assertTrue(
            '{row: 3, column: "PARC"}: "\'\'" must be pos and neg' in validation_errors)
        self.assertTrue(
            '{row: 2, column: "RPOBGBS-1"}: "\'\'" must be pos and neg' in validation_errors)
        self.assertTrue(
            '{row: 3, column: "RPOBGBS-2"}: "\'\'" must be pos and neg' in validation_errors)
        self.assertTrue(
            '{row: 2, column: "RPOBGBS-3"}: "\'\'" must be pos and neg' in validation_errors)
        self.assertTrue(
            '{row: 3, column: "RPOBGBS-4"}: "\'\'" must be pos and neg' in validation_errors)
        self.assertTrue(
            '{row: 2, column: "SUL2"}: "\'\'" must be pos and neg' in validation_errors)
        self.assertTrue(
            '{row: 3, column: "TETB"}: "\'\'" must be pos and neg' in validation_errors)
        self.assertTrue(
            '{row: 2, column: "TETL"}: "\'\'" must be pos and neg' in validation_errors)
        self.assertTrue(
            '{row: 3, column: "TETM"}: "\'\'" must be pos and neg' in validation_errors)
        self.assertTrue(
            '{row: 2, column: "TETO"}: "\'\'" must be pos and neg' in validation_errors)
        self.assertTrue(
            '{row: 3, column: "TETS"}: "\'\'" must be pos and neg' in validation_errors)
        self.assertTrue(
            '{row: 2, column: "ALP1"}: "\'\'" must be pos and neg' in validation_errors)
        self.assertTrue(
            '{row: 3, column: "ALP23"}: "\'\'" must be pos and neg' in validation_errors)
        self.assertTrue(
            '{row: 2, column: "ALPHA"}: "\'\'" must be pos and neg' in validation_errors)
        self.assertTrue(
            '{row: 3, column: "HVGA"}: "\'\'" must be pos and neg' in validation_errors)
        self.assertTrue(
            '{row: 2, column: "PI1"}: "\'\'" must be pos and neg' in validation_errors)
        self.assertTrue(
            '{row: 3, column: "PI2A1"}: "\'\'" must be pos and neg' in validation_errors)
        self.assertTrue(
            '{row: 2, column: "PI2A2"}: "\'\'" must be pos and neg' in validation_errors)
        self.assertTrue(
            '{row: 3, column: "PI2B"}: "\'\'" must be pos and neg' in validation_errors)
        self.assertTrue(
            '{row: 2, column: "RIB"}: "\'\'" must be pos and neg' in validation_errors)
        self.assertTrue(
            '{row: 3, column: "SRR1"}: "\'\'" must be pos and neg' in validation_errors)
        self.assertTrue(
            '{row: 2, column: "SRR2"}: "\'\'" must be pos and neg' in validation_errors)
        self.assertTrue(
            '{row: 3, column: "23S1_variant"}: "\'\'" contains illegal characters' in validation_errors)
        self.assertTrue(
            '{row: 3, column: "23S3_variant"}: "\'\'" contains illegal characters' in validation_errors)
