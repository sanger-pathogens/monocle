...
EXPECTED_VALIDATION_ERRORS = [
    ...
    '{row: 24, column: "Country"}: "UNKNOWNCOUNTRY" is not in the list of legal options (TestCountryA, TestCountryB, TestCountryC)',
    '{row: 29, column: "Submitting_Institution"}: "UNKNOWN" is not in the list of legal options (TesInsA, TesInsB)',
