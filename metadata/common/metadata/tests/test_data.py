...
EXPECTED_VALIDATION_ERRORS2 = [
    ...
    '{row: 2, column: "lsaC"}: "\'\'" is not in the list of legal options (pos, neg)',
    '{row: 2, column: "msrD"}: "\'\'" is not in the list of legal options (pos, neg)',
    '{row: 2, column: "tetL"}: "\'\'" is not in the list of legal options (pos, neg)',
    '{row: 2, column: "tetO"}: "\'\'" is not in the list of legal options (pos, neg)',
    '{row: 2, column: "alp1"}: "\'\'" is not in the list of legal options (pos, neg)',
    '{row: 2, column: "alpha"}: "\'\'" is not in the list of legal options (pos, neg)',
    '{row: 2, column: "PI1"}: "\'\'" is not in the list of legal options (pos, neg)',
    ...
    '{row: 3, column: "tetB"}: "\'\'" is not in the list of legal options (pos, neg)',
    '{row: 3, column: "tetM"}: "\'\'" is not in the list of legal options (pos, neg)',
    '{row: 3, column: "tetS"}: "\'\'" is not in the list of legal options (pos, neg)',
    '{row: 3, column: "tetOWO"}: "abc" is not in the list of legal options (pos, neg)',
    '{row: 3, column: "alp2/3"}: "\'\'" is not in the list of legal options (pos, neg)',
    '{row: 3, column: "hvgA"}: "\'\'" is not in the list of legal options (pos, neg)',
    '{row: 3, column: "PI2A1"}: "\'\'" is not in the list of legal options (pos, neg)',
