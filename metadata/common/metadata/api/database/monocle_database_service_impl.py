    ...
    INSERT_OR_UPDATE_SAMPLE_SQL = text(
        ...
        """ \
            INSERT INTO api_sample (
                public_name, sanger_sample_id, supplier_sample_name, lane_id, study_name, study_ref, submitting_institution,
                selection_random, country, county_state, city, collection_year, collection_month, collection_day,
                host_species, gender, age_group, age_years, age_months, age_weeks, age_days,
                host_status, disease_type, disease_onset, isolation_source, infection_during_pregnancy, maternal_infection_type, gestational_age_weeks,
                birth_weight_gram, apgar_score, serotype, serotype_method, ceftizoxime, ceftizoxime_method, cefoxitin,
